...
MAIN_URL_1 = 'http://18.188.96.242/en/'

# MAIN_URL = 'http://18.188.96.242/api/' 
# MAIN_URL_1 = 'http://18.188.96.242/en/'

def index(request,id):
    response = requests.get('http://18.188.96.242/en/api/watersupplytype/')
...
def create_watersupply(request, id):
    ...
    if request.method == "POST":
        ...
        url1 = "http://18.188.96.242/en/api/v2/watersupply"
        ...
        if 'status' in res_json:
            ...
            if id == 1:#Well
                ...
                ws_well_url = "http://18.188.96.242/en/api/watersupplywell/"
                payload_well = {
                    "watersupply_id" : res_json['data']['id'],
                ...
                if 'id' in well_res_json:
                    ws_option_value_url = "http://18.188.96.242/en/api/watersupplywelloptionvalue/"
                ...
                ws_pipe_url = "http://18.188.96.242/en/api/watersupplypipe/"
                payload_pipe = {
                    "watersupply_id" : res_json['data']['id'],
                    "is_active": True,
                ...
                if 'id' in response_pipe_json:
                    ws_pipe_option_value_url = "http://18.188.96.242/en/api/watersupplypipoptionvalue/"
                ...
                ws_kiosk_url = "http://18.188.96.242/en/api/watersupplykiosk/"
                payload_kiosk = {               
                    "watersupply_id": res_json['data']['id'],
                    "is_active": True,
                    "source_type_of_water": request.POST["source_type_of_water"],
                ...
                if 'id' in response_kiosk_json:
                    ...
                    ws_kiosk_option_value_url = "http://18.188.96.242/en/api/watersupplykioskoptionvalue/"
                ...
                ws_community_pond_url = "http://18.188.96.242/en/api/watersupplycommunitypond/"
                ...
                ws_rain_water_harvesting_url = "http://18.188.96.242/en/api/watersupplyrainwaterharvesting/"
                ...
                ws_pipe_private_url = "http://18.188.96.242/en/api/watersupplypipeprivate/"
                ...
                if 'id' in response_pipe_private_json:
                    ws_pipe_private_option_value_url = "http://18.188.96.242/en/api/watersupplypipeprivateoptionvalue/"
                    split_pipe_source_water_values = request.POST['source_type_of_water'].split(',')
                    for pipe_source_water in split_pipe_source_water_values:
                        payload_pipe_option_value = {
                ...
                ws_air_water_url = "http://18.188.96.242/en/api/watersupplyairwater/"
                payload_air_water = {               
                    "watersupply_id": res_json['data']['id'],
                    "is_active": True,
                    "source_type_of_water": request.POST["source_type_of_water"],
                ...
                if 'id' in response_air_water_json:
                    #print(response_kiosk_json)
                    ws_air_water_option_value_url = "http://18.188.96.242/en/api/watersupplyairwateroptionvalue/"
                    #print(ws_kiosk_option_value_url)
            ...
            ws_qr_code_url = "http://18.188.96.242/en/api/watersupplyqrcode/"
            payload_qr_code = {
                "watersupply_id": res_json['data']['id'],
            ...
            wqc_param_url = "http://18.188.96.242/en/api/watersupplyqualitycheckparameter/"
...
def edit(request, id):
    ...
    if request.method == "POST":
        ...
        url_update = "http://18.188.96.242/en/api/v2/watersupply/"+str(id)+"/update/"
...
def user_register(request):
    ...
    if request.method == "POST":
        ...
        url = "http://18.188.96.242/en/api/register/"
